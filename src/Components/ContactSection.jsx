    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Whether you’d like to discuss a project, collaborate on an idea, or just
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:adityadave004@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    adityadave004@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center text-muted-foreground">
                ...
                <a
                  href="https://www.instagram.com/aditya_3735/"
                  target="_blank"
                  rel="noreferrer"
                >
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} Aditya Dave. All Rights Reserved.
      </div>
    </section>
  );
};